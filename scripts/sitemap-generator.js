...
const staticRoutes = [
  ...
  { path: '/blog/seo/estrategia-seo-ecommerce-argentina-migracion-tiendanube', priority: 0.9, changefreq: 'weekly' },
  { path: '/resources/estrategia-seo-ecommerce-argentina', priority: 0.8, changefreq: 'monthly' },
  { path: '/recursos/estrategia-seo-ecommerce-argentina', priority: 0.8, changefreq: 'monthly' },
