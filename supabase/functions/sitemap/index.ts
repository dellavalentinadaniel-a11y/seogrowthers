...
const STATIC_PAGES = [
  ...
  { loc: '/forum', changefreq: 'daily', priority: '0.8' },
  { loc: '/news', changefreq: 'daily', priority: '0.9' },
  { loc: '/services', changefreq: 'weekly', priority: '0.9' },
  { loc: '/services/seo-neuquen', changefreq: 'weekly', priority: '0.9' },
  { loc: '/services/desarrollo-web-argentina', changefreq: 'weekly', priority: '0.9' },
  { loc: '/services/automatizacion-ia', changefreq: 'weekly', priority: '0.9' },
  ...
  { loc: '/services/ia-agentica-agentes', changefreq: 'weekly', priority: '0.8' },
  { loc: '/services/success-cases', changefreq: 'weekly', priority: '0.8' },
  { loc: '/services/testimonials', changefreq: 'weekly', priority: '0.7' },
  { loc: '/services/success-cases/aluvalle-transformacion-digital', changefreq: 'monthly', priority: '0.7' },
  { loc: '/services/success-cases/inmofuture-plataforma-inmobiliaria', changefreq: 'monthly', priority: '0.7' },
  { loc: '/services/success-cases/edv-remolques-tactica-logistica', changefreq: 'monthly', priority: '0.7' },
  { loc: '/services/success-cases/seo-growthers-plataforma-ecosistema', changefreq: 'monthly', priority: '0.7' },
  { loc: '/resources', changefreq: 'weekly', priority: '0.8' },
  { loc: '/recursos', changefreq: 'weekly', priority: '0.8' },
  { loc: '/resources/google-seo-fundamentals', changefreq: 'monthly', priority: '0.8' },
  { loc: '/resources/google-ai-studio-2026', changefreq: 'monthly', priority: '0.8' },
  { loc: '/resources/ssd-ps5-optimization-2026', changefreq: 'monthly', priority: '0.8' },
  ...
  { loc: '/trabaja-con-nosotros', changefreq: 'monthly', priority: '0.5' },
