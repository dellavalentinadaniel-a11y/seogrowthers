              ...
              <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {category.services.map((service, sIndex) => (
                    ...
                    >
                      ...
                      <div className="mt-auto pt-6 border-t border-outline/10">
                        <a href="https://studioseogrowthers.vercel.app/" target="_blank" rel="noopener noreferrer" className={`text-sm font-bold uppercase tracking-wider flex items-center gap-2 ${category.textColor} group-hover:gap-3 transition-all`}>
                          Comenzar
                  ...
                  <div className={`glass-panel flex flex-col items-center justify-center p-8 rounded-3xl border border-dashed ${category.borderColor} bg-transparent hover:bg-surface/40 transition-colors duration-300 text-center`}>
                    ...
                    <a href="https://studioseogrowthers.vercel.app/" target="_blank" rel="noopener noreferrer" className={`px-6 py-3 rounded-xl bg-surface-variant text-on-surface font-bold text-sm border border-outline/20 hover:border-outline/40 transition-colors`}>
                      Contactar Ventas
                    </a>
                  </div>
                </div>
