...
const breadcrumbNames = {
  ...
  'portfolio': 'Portfolio',
  'rpa-automatizacion': 'Automatización RPA',
  'integraciones-no-code': 'Integraciones No-Code',
  'ia-agentica-agentes': 'Agentes de IA',
  'inmofuture-plataforma-inmobiliaria': 'InmoFuture',
